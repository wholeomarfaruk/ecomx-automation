@php
    $supportPhone = ltrim(config('ecomx-anyniche.phone'), '+');
    $supportWhatsapp = $supportPhone;
    $supportMessenger = 'https://m.me/anyniche';
@endphp
...
<div class="jtc-modal-scrim" :class="$store.ui.supportOpen && 'is-open'" @click="$store.ui.supportOpen = false" x-cloak>
    <div class="jtc-modal jtc-modal--support" @click.stop>
        <div class="jtc-modal__head jtc-modal__head--brand">
            ...
            <p>Reach {{ \App\Models\Setting::get('site_name', 'AnyNiche') ?: 'AnyNiche' }} any way you like.</p>
        </div>
