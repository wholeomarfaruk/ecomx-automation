<div x-data="{ open: @entangle('isOpen').live }" x-cloak>
    <div x-show="open" x-transition.opacity
        class="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-black/60 p-4 overflow-y-auto"
        ...
        <div x-show="open"
            ...
            class="w-full max-w-3xl my-8 rounded-xl bg-white shadow-2xl flex flex-col max-h-[90vh]">
