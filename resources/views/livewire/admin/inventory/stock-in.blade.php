<div x-data x-init="$store.pageName = { name: 'Stock In', slug: 'inventory-stock-in' }">
    ...
    <form wire:submit.prevent="submit" class="max-w-2xl space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-4">
            <div>
                <span class="block text-sm font-semibold text-gray-800">Batch / Lot</span>
                <span class="block text-xs text-gray-400">Every stock-in is recorded against a batch/lot number, for FEFO issuing and expiry alerts.</span>
            </div>
