<div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-16 text-center">
    ...
    <p class="text-sm font-semibold text-gray-700">No login account linked</p>
    <p class="text-xs text-gray-400 mt-0.5">This data is tracked against a staff/login account, and this customer has none.</p>
</div>
