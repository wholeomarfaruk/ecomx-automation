...
class WishlistDrawer extends Component
{
    ...
    {
        // Cart persistence for the ecomx-anyniche theme is not wired to the
        // backend yet (see resources/ecomx-anyniche/js/app.js — cartItems is
    ...
    {
        return view('livewire.ecomx-anyniche.wishlist-drawer', [
            'groups' => $this->groups,
        ]);
    }
}
