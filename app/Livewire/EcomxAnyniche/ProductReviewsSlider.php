...
/**
 * Reviews carousel for the ecomx-anyniche product page. Shows this product's
...
class ProductReviewsSlider extends Component
{
    ...
    {
        return view('ecomx-anyniche.livewire.product-reviews-slider-placeholder');
    }

    public function render()
    {
        return view('ecomx-anyniche.livewire.product-reviews-slider');
    }
}
