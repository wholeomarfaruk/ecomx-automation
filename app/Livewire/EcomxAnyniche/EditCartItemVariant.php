 ...
 * modal in the cart drawer (livewire.ecomx-anyniche.cart-manager). Only
 * loads/renders anything when the item's product actually has variants —
 * mirrors App\Livewire\EcomxAnyniche\Product::loadRealVariants() so the same
...
class EditCartItemVariant extends Component
{
    ...
    {
        return view('livewire.ecomx-anyniche.edit-cart-item-variant');
    }
}
