...
/**
 * ecomx-anyniche's own copy of App\Livewire\Website\CartManager — kept
 ...
 * (livewire.ecomx-anyniche.cart-manager, reusing the theme's existing
...
class CartManager extends Component
{
     ...
     * item" modal (App\Livewire\EcomxAnyniche\EditCartItemVariant). If the
    ...
    public function render()
    {
        ...
        return view('livewire.ecomx-anyniche.cart-manager', [
